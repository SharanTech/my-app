pipeline{
    ...
    stages{
        ...
        stage("Docker deploy"){
            steps{
                ansiblePlaybook become: true, credentialsId: 'Test', disableHostKeyChecking: true, extras: "-e Docker_Tag=${Docker_Tag}", installation: 'ansible', inventory: 'dev.inv', playbook: 'DeployingDocker.yml', 
